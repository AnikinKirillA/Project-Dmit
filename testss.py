...
# === Примеры ===
print(to_rpn("-6 + x"))          # ['-6', 'x', '+']
print(to_rpn("-x^2 + 3"))        # ['-x^2', '3', '+']
print(to_rpn("3x - -2x"))        # ['3', 'x', '*', '-2x', '-']
print(to_rpn("(-x + 2) * 5"))    # ['-x', '2', '+', '5', '*']
print(to_rpn("-x^1 + 6"))       # ['-x^1', '-6', '+']
print(to_rpn("(56/3)*x^5 + 2x^3"))
print(to_rpn("56/3x^5 + 2x^3"))
print(to_rpn("(-56/ -3)*x^5 + 2x^3"))
print(to_rpn("(-56/ -3)x^5 + 2x^3"))
print(to_rpn("(-56x/ -3)*x^5 + 2x^3"))
print(to_rpn("(56/3)*(x^5 + 2x^3)"))
print(to_rpn("x^(7+8)"))

'''
print(to_rpn("(x^6 + 4) // 7"))
print(to_rpn("56/3x^5"))
print(to_rpn("(56/3)*x^5 + 2x^3"))
print(to_rpn("2x + 3"))
print(to_rpn("x^2 + 5x + 6"))
'''